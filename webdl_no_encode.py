...
print("by parnex")
print("Required files : ffmpeg.exe yt-dlp.exe, mkvmerge.exe, mp4decrypt.exe, aria2c.exe\n")
...
if args.subtitle:
    ...
    print("Merging .....")
    subprocess.run([ffmpegexe, '-i', 'decrypted.mp4', '-i', 'decrypted.m4a', '-vcodec', 'copy', '-acodec', 'copy', '-movflags', 'faststart', output +'.mp4'])
    print("\nAll Done .....")  
